...
def calc_buttons(window, cell): #ustawia ustawia cyfry i operatory działań
    ...
    button_back = tk.Button(window, text='\u21BA', bg='white', borderwidth=0, command=lambda: last(cell))
    ...
    button_clr = tk.Button(window, text='C', bg='white', borderwidth=0, command=lambda: clear(cell))
    ...
    button_leftbracket = tk.Button(window, text='(', bg='white', borderwidth=0, command=lambda: put_button(cell, '('))
    ...
    button_rightbracket = tk.Button(window, text=')', bg='white', borderwidth=0,command=lambda: put_button(cell, ')'))
    ...
    button_1 = tk.Button(window, text='1', bg='white', borderwidth=0, command=lambda: put_button(cell, '1'))
    button_1.grid(row=5, column=0, ipadx=10, ipady=5)
    button_1.configure(width=5, height=2, font=("Calibri", 13))
    buttons.append(button_1)

    button_2 = tk.Button(window, text='2', bg='white', borderwidth=0, command=lambda: put_button(cell, '2'))
    button_2.grid(row=5, column=1, ipadx=10, ipady=5)
    button_2.configure(width=5, height=2, font=("Calibri", 13))
    buttons.append(button_2)

    button_3 = tk.Button(window, text='3', bg='white', borderwidth=0, command=lambda: put_button(cell, '3'))
    button_3.grid(row=5, column=2, ipadx=10, ipady=5)
    button_3.configure(width=5, height=2, font=("Calibri", 13))
    buttons.append(button_3)

    button_minus = tk.Button(window, text='-', bg='white', borderwidth=0, command=lambda: put_button(cell, '-'))
    ...
    button_pow = tk.Button(window, text='x^2', bg='white', borderwidth=0,command=lambda: put_button(cell, '^2'))
    ...
    button_sqrt = tk.Button(window, text='\u221Ax', bg='white', borderwidth=0, command=lambda: put_button(cell, '**(0.5)'))
    ...
    button_0 = tk.Button(window, text='0', bg='white', borderwidth=0, command=lambda: put_button(cell, '0'))
    button_0.grid(row=6, column=0, ipadx=10, ipady=5)
    button_0.configure(width=5, height=2, font=("Calibri", 13))
    buttons.append(button_0)

    button_comma = tk.Button(window, text=',', bg='white', borderwidth=0, command=lambda: put_button(cell, '.'))
    ...
    button_percent = tk.Button(window, text='%', bg='white', borderwidth = 0, command=lambda: put_button(cell, '%'))
    ...
    button_plus = tk.Button(window, text='+', bg='white', borderwidth=0,command=lambda: put_button(cell, '+'))
...
def put_button(cell, sign):    #funkcja dodająca wcisniete przyciski
    expression = cell.get()
    res = str(expression) + sign
    cell.delete(0, tk.END)
    cell.insert(tk.END, str(res))

def clear(cell):  #funkcja czyszczaca pole do wpisywania
    cell.delete(0, tk.END)

def last(cell): #funkcja zwracająca ostatnie równanie
    cell.delete(0, tk.END)
